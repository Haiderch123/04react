  ...
  return (
    <NavigationMenu viewport={isMobile} className="z-50">
      <NavigationMenuList className="flex-wrap gap-10 ">
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-white font-bold bg-black">
            Vehicles
          </NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid  gap-2  sm:w-[400px] md:w-[500px] md:grid-cols-2 lg:w-[600px] z-50">
        ...
        <NavigationMenuItem className="hidden md:block ">
          <NavigationMenuTrigger className=" bg-black font-bold text-white">
            Book Now
          </NavigationMenuTrigger>
          <NavigationMenuContent>
